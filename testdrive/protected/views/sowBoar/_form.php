...
<table>
	...
	<tr><td><div class="row">
		...
		<?php echo $form->textField($model,'sire_notch',array('size'=>20,'maxlength'=>20,'onBlur'=>'searchSireDam(this,\'sirename\')','id'=>'sire_notch')); ?>
		<?php echo $form->error($model,'sire_notch'); ?>
	</div></td><td id="sirename" style="color: red; "></td></tr>

	<tr><td><div class="row">
		<?php echo $form->labelEx($model,'dam_notch'); ?>
		<?php echo $form->textField($model,'dam_notch',array('size'=>20,'maxlength'=>20,'onBlur'=>'searchSireDam(this,\'damname\')','id'=>'dam_notch')); ?>
